...
insert into public.groups (id, name, created_by, code) values
  ('20000000-0000-0000-0000-000000000001', 'Group G', '10000000-0000-0000-0000-000000000001', 'ROLG'),
  ('20000000-0000-0000-0000-000000000002', 'Group H', '10000000-0000-0000-0000-000000000005', 'ROLH');

insert into public.group_memberships (id, group_id, user_id, display_name, status, member_number) values
  ('30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'Admin1', 'ACTIVE', 'ROLG-2026-0001'),
  ('30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', 'Admin2', 'ACTIVE', 'ROLG-2026-0002'),
  ('30000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000003', 'Chair', 'ACTIVE', 'ROLG-2026-0003'),
  ('30000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000004', 'Member1', 'ACTIVE', 'ROLG-2026-0004'),
  ('30000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000005', 'AdminH', 'ACTIVE', 'ROLH-2026-0001'),
  ('30000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000002', null, 'BystanderH', 'ACTIVE', 'ROLH-2026-0002');
